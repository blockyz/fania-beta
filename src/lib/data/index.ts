import { IExhibition, ICategory, IEventDetail, IStatistic, ICertification, IBlogDetail, IProductDetail, IProductCard, ILandingHero, IEventItem, IInnovation } from '../types/index';
...
export const getProducts = (): IProductCard[] => {
  return productsData
}